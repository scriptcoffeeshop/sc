export function registerDashboardGlobals(deps) {
  ...
  Object.assign(window, {
    ...
    previewIcon: deps.previewIcon,
    uploadSiteIcon: deps.uploadSiteIcon,
    resetSiteIcon: deps.resetSiteIcon,
    uploadSectionIcon: deps.uploadSectionIcon,
    uploadPaymentIcon: deps.uploadPaymentIcon,
    uploadDeliveryRowIcon: deps.uploadDeliveryRowIcon,
    applyIconFromLibrary: deps.applyIconFromLibrary,
