...
- 後台是優先遷移區：
  ...
  - `settings` 的 `delivery / payment / linepay sandbox` 已改成 Vue-owned state/actions (`useDashboardSettings.js`)
  - `settings` 剩餘的主要 legacy orchestration 集中在品牌欄位、區塊標題與匯款帳號管理
