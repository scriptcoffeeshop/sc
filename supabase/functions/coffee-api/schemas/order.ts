...
export const submitOrderSchema = z.object({
    ...
    deliveryMethod: z.enum(['delivery', 'home_delivery', 'seven_eleven', 'family_mart', 'in_store']),
    ...
    transferAccountLast5: z.string().optional().refine((v: string | undefined) => !v || /^\d{5}$/.test(v), '帳號末五碼應為5位數字'),
})
