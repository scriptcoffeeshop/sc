...
export async function linePaySign(channelSecret: string, apiPath: string, body: string, nonce: string): Promise<string> {
...
export async function requestLinePayAPI(method: string, apiPath: string, data: unknown = null): Promise<any> {
