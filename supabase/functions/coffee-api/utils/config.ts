...
export const LINE_LOGIN_CHANNEL_SECRET = Deno.env.get('LINE_LOGIN_CHANNEL_SECRET') || '';
...
export const FRONTEND_URL = Deno.env.get('FRONTEND_URL') || 'https://scriptcoffeeshop.github.io/sc';
...
export const VALID_ORDER_STATUSES = ['pending', 'processing', 'shipped', 'completed', 'cancelled'];
